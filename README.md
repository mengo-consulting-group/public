...
| Platform | Installer |
|----------|-----------|
| macOS (Apple Silicon) | [**Download .dmg**](https://github.com/mengo-consulting-group/public/releases/latest/download/capai-arm64.dmg) |
| Windows x64 | [**Download .exe**](https://github.com/mengo-consulting-group/public/releases/latest/download/capai-x64-setup.exe) |
| Linux x64 (AppImage) | [**Download .AppImage**](https://github.com/mengo-consulting-group/public/releases/latest/download/capai_x64.AppImage) |
